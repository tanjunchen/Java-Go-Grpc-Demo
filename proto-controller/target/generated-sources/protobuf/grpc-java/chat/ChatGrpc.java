...
public final class ChatGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<chat.ChatOuterClass.Request,
      chat.ChatOuterClass.Response> getBindStreamMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "BindStream",
      requestType = chat.ChatOuterClass.Request.class,
      responseType = chat.ChatOuterClass.Response.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<chat.ChatOuterClass.Request,
      chat.ChatOuterClass.Response> getBindStreamMethod() {
    io.grpc.MethodDescriptor<chat.ChatOuterClass.Request, chat.ChatOuterClass.Response> getBindStreamMethod;
    if ((getBindStreamMethod = ChatGrpc.getBindStreamMethod) == null) {
      synchronized (ChatGrpc.class) {
        if ((getBindStreamMethod = ChatGrpc.getBindStreamMethod) == null) {
          ChatGrpc.getBindStreamMethod = getBindStreamMethod = 
              io.grpc.MethodDescriptor.<chat.ChatOuterClass.Request, chat.ChatOuterClass.Response>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "chat.Chat", "BindStream"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  chat.ChatOuterClass.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  chat.ChatOuterClass.Response.getDefaultInstance()))
                  .setSchemaDescriptor(new ChatMethodDescriptorSupplier("BindStream"))
                  .build();
          }
        }
     }
     return getBindStreamMethod;
  }
  ...
  public static abstract class ChatImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<chat.ChatOuterClass.Request> bindStream(
        io.grpc.stub.StreamObserver<chat.ChatOuterClass.Response> responseObserver) {
      return asyncUnimplementedStreamingCall(getBindStreamMethod(), responseObserver);
    }
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                chat.ChatOuterClass.Request,
                chat.ChatOuterClass.Response>(
                  this, METHODID_BIND_STREAM)))
          .build();
    }
  }
  ...
  public static final class ChatStub extends io.grpc.stub.AbstractStub<ChatStub> {
    ...
    public io.grpc.stub.StreamObserver<chat.ChatOuterClass.Request> bindStream(
      ...
      return asyncBidiStreamingCall(
          getChannel().newCall(getBindStreamMethod(), getCallOptions()), responseObserver);
    }
  }
  ...
  private static final int METHODID_BIND_STREAM = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public io.grpc.stub.StreamObserver<Req> invoke(
      ...
      switch (methodId) {
        case METHODID_BIND_STREAM:
          return (io.grpc.stub.StreamObserver<Req>) serviceImpl.bindStream(
              (io.grpc.stub.StreamObserver<chat.ChatOuterClass.Response>) responseObserver);
        default:
          throw new AssertionError();
      }
